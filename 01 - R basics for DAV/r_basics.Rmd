...
You can see that tidyverse contains no less than 8 packages. We are mostly going to use `ggplot2` and `dplyr`. In the next practical, we are going to learn about how to use `dplyr` for data manipulation.
